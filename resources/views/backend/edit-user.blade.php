    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form id="editUser" class="row" enctype="multipart/form-data"
                    action="{{ url('update-user', $users['id']) }}" method="post">
                    {{ csrf_field() }}
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="role-type">
                                @if ($users->role == 'Hr')
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="role" value="Preservice">
                                ...
                                @elseif($users->role == 'Preservice')
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="role" value="Preservice" checked>
                                            <span><i></i>Pre-service</span>
                                        </label>
                                    </div>
                                    <div class="radio">
                                ...
                                @elseif($users->role == 'Supervisor')
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="role" value="Supervisor" checked>
                                            <span><i></i>Supervisor</span>
                                        </label>
                                    </div>
                                @else
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="role" value="Preservice" disabled>
                                            <span><i></i>Pre-service</span>
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="role" value="Supervisor" disabled>
                                            <span><i></i>Supervisor</span>
                                        </label>
                                    </div>
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group visible-xs">
                                <input id="password1" type="text" name="passwordSmall"
                                    class="form-control password top center-block" placeholder="Enter new password">
                                <button type="button" class="btn btn-primary top center-block"
                                    onclick="pasGeneration()">
                                    Generate
                                </button>
                            </div>
                            ...
                            @if ($users->status == 'Active')
                                <input class="form-control" id="checkbox" name="status" type="checkbox"
                                    data-toggle="toggle-groupgle-offggle" data-on="Active" data-off="Inactive"
                                    checked>
                            @else
                                <input class="form-control" id="checkbox" name="status" type="checkbox"
                                    data-toggle="toggle-groupgle-offggle" data-on="Active" data-off="Inactive">
