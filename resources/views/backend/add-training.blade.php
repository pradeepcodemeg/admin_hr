    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form id="post_training" class="row" enctype="multipart/form-data" action="{{ url('add-training') }}"
                    method="post">
                    {{ csrf_field() }}
                    <div class="clearfix">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" title="Choose a PDF file" name="file" class="btn-primary"
                                    required accept="application/pdf">
                                <label class="top">Minimum time (HH:MM) (max - 23:59)</label>
                                <input type="text" class="form-control" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]"
                                    id="minTime" name="minimun_time" placeholder="HH:MM" required />
                                <label class="top">Credit Hours (HH:MM)</label>
                                <input type="text" class="form-control" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]"
                                    id="creditTime" name="credit_hours" placeholder="HH:MM" required />
                                <label class="top">Select Training Avalibility Group</label>
                                <select class="form-control" name="assign_role" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="youtube_link"
                                    placeholder="Add youtube link here" id="Ulink">
                            </div>
                        </div>
                    </div>
