                                ...
                                <table class="table">
                                    <tbody>
                                        @foreach ($msg_data as $msg)
                                            ...
                                            @endphp
                                            <tr class="pointer"
                                                data-href="{{ asset('view-outbox-message/' . $msg->message_id) }}">
                                                ...
                                                <td class="delete-btn outbox"
                                                    data-id="{{ encrypt($msg->message_id) }}">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="compose-mail">
                        <form onsubmit="return false" enctype="multipart/form-data" id="frm-send" action="{{ url('send-message') }}" method="post">
                            {{ csrf_field() }}
                            <div class="m-header">
