        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="top-buttons all-buttons">
                ...
                <span class="all-buttons-right">
                    ...
                    <button id="active" class="btn btn-primary bottom" style="margin-right: 10px;" value="Active">Active
                    </button>
                    <button id="inactive" class="btn btn-primary bottom"  style="margin-right: 10px;" value="Inactive">Inactive
                    </button>
                    <button id="archive" class="btn btn-primary bottom"  style="margin-right: 10px;" value="Archive">Archive
                    </button>
                    <button onclick="window.location.href='{{url('add-training')}}'" class="btn btn-primary bottom visible-xs"><i class="glyphicon glyphicon-plus"></i></i></button>                    
                    <button onclick="window.location.href='{{url('add-training')}}'" class="btn btn-primary bottom hidden-xs"><i class="glyphicon glyphicon-plus"></i> Add training</button>
                </span>
            </h1>
