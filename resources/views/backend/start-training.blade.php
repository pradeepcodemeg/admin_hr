...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form id="post_training" class="row" enctype="multipart/form-data" action="{{ url('add-duplicate', $training_list->id) }}" method="post">
                {{ csrf_field() }}
                <div class="clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="training_name"  value="{{$training_list->training_name}}" placeholder="Enter training name" required />
                            <label class="top">Choose PDF training file</label>
                            <input type="file" title="Choose file" name="file" class="btn-primary" accept="application/pdf">
                            <label class="top">Minimum time (HH:MM) (max - 23:59)</label>
                            <input type="text" class="form-control" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]" id="minTime" name="minimun_time" placeholder="HH:MM" value="{{date('H:i', strtotime($training_list->minimun_time)) }}" required/>
                            <label class="top">Credit Hours (HH:MM)</label>
                            <input type="text" class="form-control" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]" id="creditTime" name="credit_hours" placeholder="HH:MM" value="{{date('H:i', strtotime($training_list->credit_hours)) }}" required/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Training deadline (dd:mm:yyyy)</label>
                            <input type="text" id="generate_dates" class="form-control" name="training_deadline" value="{{ $training_list->training_deadline }}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="video-file role-type" type="none" style="margin-bottom: 21px;">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="slide" value="first_slide" @if($training_list->slide == "first_slide") checked @endif>
                                        <span><i></i> At first slide</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="slide" value="last_slide" @if($training_list->slide == "last_slide") checked @endif>
                            ...
                            <input type="text" class="form-control" name="youtube_link" placeholder="Add youtube link here" value="{{$training_list->youtube_link}}" id="Ulink">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                            ...
                            <thead>
                                <tr>
                                    <th>
                                        ...
                                        <input type="text" value="{{$question_list[$i]->question}}" name="question[]" class="form-control" placeholder="Add question here" id="que<?php echo $i ?>">
                                        @else
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="option_one[]" class="form-control" value="{{$question_list[$i]->option_one}}" id="option_one<?php echo $i;?>" placeholder="Add option 1 here">
                                        @else
                                        ...
                                        <div class="role-type">
                                                <div class="radio">
                                                    <label>
                                                        ...
                                                        <input type="radio" name="correct_option<?php echo $i ?>" value="option_one" checked>
                                                        @else
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" value="{{$question_list[$i]->option_two}}" name="option_two[]" class="form-control" id="option_two<?php echo $i;?>" placeholder="Add option 2 here">
                                        @else
                                        ...
                                        <div class="role-type">
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    <input type="radio" name="correct_option<?php echo $i ?>" value="option_two" checked>
                                                    @else
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" value="{{$question_list[$i]->option_three}}" name="option_three[]" class="form-control" id="option_three<?php echo $i;?>" placeholder="Add option 3 here">
                                        @else
                                        ...
                                        <div class="role-type">
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    <input type="radio" name="correct_option<?php echo $i ?>" value="option_three" checked>
                                                    @else
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" value="{{$question_list[$i]->option_four}}" name="option_four[]" class="form-control" id="option_four<?php echo $i;?>" placeholder="Add option 4 here">
                                        @else
                                        ...
                                        <div class="role-type">
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    <input type="radio" name="correct_option<?php echo $i ?>" value="option_four" checked>
                                                    @else
