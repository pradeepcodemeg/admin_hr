    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <section class="all-mails-list">
				...
				<div class="footer">
					<button data-toggle="modal" data-target="#reply-mail"> <i class="glyphicon glyphicon-share-alt"></i> Reply</button>
					<button data-toggle="modal" data-target="#forward-mail"> <i class="glyphicon glyphicon-arrow-right"></i> Forward</button>
      	...
      	<form enctype="multipart/form-data" action="{{url('send-message')}}" method="post">
                			...
                			<input type="text" name="message_id" value="{{$messages->message_id}}" hidden>
								...
								@foreach($users as $person)
										...
										<option value="{{$person['id']}}" {{($person['id'] == $user->id)?'selected':''}}>{{$person['firstname']}} {{$person['lastname']}} </option>
										@endif
								@endforeach
										</select>
									</div>
								...
								<div class="m-body">
									<div class="sender-d clearfix">
										<div class="profile-txt clearfix">
											<div class="img">
												<img src="{{asset('public/')}}{{$image}}" class="img-circle">
											</div>
											<div class="txt">
												<p> <label>{{$firstname}} {{$lastname}}</label> <span>{{$email}}</span> </p>
											</div>
										</div>
