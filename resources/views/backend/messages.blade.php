            ...
            <section class="all-mails-list">
				...
				<div class="mail-list-body">
					...
					@foreach ($msg_data as $msg)
						@php 
							$my_msg = DB::table('messages')->orderBy('created_at')->where('message_id', $msg->message_id)->first();
						...
						@endphp
						<tr class="pointer {{($send_data->is_read != 1)?'unseen':''}}" data-href="{{asset('view-message/'.$msg->message_id)}}">
