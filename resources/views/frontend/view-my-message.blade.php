                    ...
                    <div class="mail-details-body">
                        ...
                        <div class="header">
                            ...
                            <div class="sender-d clearfix">
                                <div class="profile-txt clearfix">
                                    ...
                                    <div class="txt">
                                        <p> <label> {{ $send_user->firstname }} {{ $send_user->lastname }} </label>
                                            <span>{{ $send_user->email }} to me</span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="footer">
                            <button data-toggle="modal" data-target="#reply-mail"> <i
                                    class="glyphicon glyphicon-plus"></i>Reply</button>
                            <button data-toggle="modal" data-target="#forward-mail"> <i
                                    class="glyphicon glyphicon-plus"></i>Forward</button>
                        </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="compose-mail">
                                            <form id="frm-send" enctype="multipart/form-data" action="{{ url('send-message') }}"
                                                            ...
                                                            @foreach ($all_user as $person)
                                                                @if ($person['role'] == 'Admin' || $person['role'] == 'Hr')
                                                                    <option value="{{ $person['id'] }}"
                                                                        {{ $person['id'] == $send_user->id ? 'selected' : '' }}>
                                                                        {{ $person['firstname'] }}
                                                                        {{ $person['lastname'] }}
                                                                    </option>
                                                                @endif
                                                ...
                                                <div class="foot clearfix">
                                                    <div class="left">
                                                        <button id="frm_submit" class="send" type="submit">Send</button>
                        ...
                        <div class="modal fade" id="forward-mail" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="compose-mail">
                                            <form id="form-forward" enctype="multipart/form-data" action="{{ url('send-message') }}"
                                                method="post">
                                                {{ csrf_field() }}
                                                <input type="text" name="message_id"
                                                    value="{{ $messages->message_id }}" hidden>
                                                ...
                                                <div class="foot clearfix">
                                                    <div class="left">
                                                        <button class="send" id="submit-forward" type="submit">Send</button>
                                                        <button class="attachment" type="button">
                                                            <label>
                                                                <input type="file" name="attachment[]" multiple
                                                                    id="img">
